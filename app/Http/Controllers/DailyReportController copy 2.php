...
class DailyReportController extends Controller
{
    ...
    //             'check_in_time' => 'Belum Check-in',
    //             'check_out_time' => 'Belum Check-out',
    //         ], 200);
    //     }

    //     if (!Schema::hasTable('attendances')) {
    //         return response()->json([
    //             'status' => 'Data absensi belum tersedia',
    //             'check_in_time' => 'Belum Check-in',
    //             'check_out_time' => 'Belum Check-out',
    //         ], 200);
    //     }

    //     $q = DB::table('attendances')->where('student_id', $studentId);
    //     if (Schema::hasColumn('attendances', 'date')) {
    //         $q->whereDate('date', $date);
    //     } elseif (Schema::hasColumn('attendances', 'attendance_date')) {
    //         $q->whereDate('attendance_date', $date);
    //     } else {
    //         $q->whereDate('created_at', $date);
    //     }

    //     $att = $q->orderByDesc('id')->first();

    //     $in  = $att->check_in_time  ?? 'Belum Check-in';
    //     $out = $att->check_out_time ?? 'Belum Check-out';
    //     $status = ($att && $att->check_in_time) ? 'Hadir' : 'Belum Hadir';

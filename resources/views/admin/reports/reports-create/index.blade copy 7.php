                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-4 w-full">
                                            <h3 class="text-sm font-bold text-green-800 uppercase tracking-wide">Data
                                                Pengukuran Terbaru Ditemukan</h3>
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-4">
                                            <h3 class="text-sm font-bold text-yellow-800 uppercase tracking-wide">Data
                                                Pengukuran Belum Tersedia</h3>
                                            <p class="text-sm text-yellow-700 mt-1">Sistem tidak menemukan data fisik
                                                terbaru. Silakan input manual di bawah ini.</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="info_perkembangan" id="info_perkembangan" rows="6" oninput="autoResize(this)"
                                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-3"
                                            placeholder="Tuliskan kesimpulan pertumbuhan fisik di sini...">{{ old('info_perkembangan', $growthNarration) }}</textarea>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div id="upload_box_kms"
                                            class="bg-gray-50 p-4 rounded-lg border border-dashed border-gray-300 text-center">
                                        ...
                                        <div id="preview_container_kms"
                                            ...
                                            <img src="" id="img_prev_development_info_photo"
                                                alt="Preview KMS"
                        ...
                        <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200">
                            <div class="bg-gray-800 px-6 py-4 text-center">
                                <h3 class="text-lg font-bold text-white uppercase tracking-wider">Lembar Pengesahan
                                    Digital</h3>
                                <p class="text-xs text-gray-400 mt-1">Silakan tanda tangan pada kotak yang tersedia.
                                </p>
                            </div>

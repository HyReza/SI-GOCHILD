<x-app-layout>
                        ...
                        <div class="col-span-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div>
                                ...
                                <input type="text" name="report_title" value="Laporan Capaian Pembelajaran"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm transition duration-150"
                                    required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="class_name"
                                    ...
                                    <option value="Early Childhood Day Care A">Early Childhood Day Care A</option>
                                    <option value="Early Childhood Day Care B">Early Childhood Day Care B</option>
                                </select>
                            </div>
                            <div>
    ...
    <script>
        // --- 1. HANDLE FILE PREVIEW & REMOVE (SAMA) ---
        ...
        // --- 3. [UPDATED] GENERATE DRAFT PER TEMA (PARAGRAF & OVERWRITE & NAME) ---
        function generateThemeDraft(themeId, targetId) {
            ...
            // Helper untuk menggabungkan kata dengan koma dan "dan" (ex: "makan, minum, dan tidur")
            ...
            if (groups['BSH'].length > 0) {
                // Tambahkan variasi kata sambung jika sudah ada kalimat sebelumnya
            ...
            // 3. Gabungkan menjadi paragraf
            const draftText = sentences.join(' ');

            // 4. Overwrite (Ganti isi textarea sepenuhnya)

    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Detail Laporan Capaian Pembelajaran') }}
            </h2>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-col md:flex-row items-end -mt-12 mb-6">
                        <div class="relative z-10">
                            <div class="w-32 h-32 rounded-2xl border-4 border-white shadow-lg overflow-hidden bg-white">
                                @if ($report->student->photo && Storage::disk('public')->exists($report->student->photo))
                        ...
                        <div class="mt-6 md:mt-0 text-right">
                            @php
                                $month = \Carbon\Carbon::parse($report->start_date)->month;
                                $semester = $month >= 7 ? 'Semester 1 (Ganjil)' : 'Semester 2 (Genap)';
                                $year = \Carbon\Carbon::parse($report->start_date)->year;
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 lg:col-span-2 flex flex-col">
                    ...
                    <div class="grid grid-cols-2 gap-6 mb-6">
                        <div
                            ...
                            <p class="text-4xl font-bold text-blue-700">{{ $report->weight + 0 }} <span
                                    class="text-lg text-gray-500 font-medium">kg</span></p>
                        </div>
                        <div
                            ...
                            <p class="text-4xl font-bold text-green-700">{{ $report->height + 0 }} <span
                                    class="text-lg text-gray-500 font-medium">cm</span></p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-8">
                <div class="px-8 py-6 bg-white border-b border-gray-200">
                    <h3 class="text-xl font-bold text-gray-800 flex items-center">
                        <i class="fas fa-book-reader mr-3 text-indigo-600"></i>Capaian Perkembangan (Narasi)
                    </h3>
                </div>

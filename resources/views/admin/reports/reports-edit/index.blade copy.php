    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('reports.update', $report->id) }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div>
                                ...
                                <select name="semester"
                                    ...
                                    <option value="1 (Ganjil)"
                                        {{ old('semester', $report->semester) == '1 (Ganjil)' ? 'selected' : '' }}>
                                        Semester 1 (Ganjil)</option>
                                    <option value="2 (Genap)"
                                        {{ old('semester', $report->semester) == '2 (Genap)' ? 'selected' : '' }}>
                ...
                <div class="mb-6 border-b border-gray-200 bg-white rounded-t-xl shadow-sm sticky top-0 z-20">

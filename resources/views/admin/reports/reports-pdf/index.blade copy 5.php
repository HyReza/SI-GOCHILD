...
<head>
    ...
    <style>
        ...
        /* Tambahan untuk narasi agar line break terbaca */
        .pre-wrap {
...
<body>
            ...
            <td width="70%">
                <table width="100%" style="font-size: 12pt;">
                    ...
                    <tr>
                        ...
                        <td>Jenis Kelamin</td>
                        <td>:</td>
                        <td>{{ $report->student->gender == 1 ? 'Laki-laki' : 'Perempuan' }}</td>
                    </tr>
                    <tr>
                        <td>5.</td>
    ...
    <div style="font-size: 8pt; margin-top: 5px; margin-bottom: 20px;">*Keterangan: <b>BB</b> (Belum Berkembang),
        <b>MB</b> (Mulai Berkembang), <b>BSH</b> (Berkembang Sesuai Harapan), <b>BSB</b> (Berkembang Sangat Baik)</div>
                ...
                @if ($note)
                    <div class="avoid-break" style="margin-bottom: 10px; border: 1px solid #000; padding: 0;">
                        <div class="bold"
                            ...
                            {{ $themeName }}</div>
                        <div class="text-justify pre-wrap" style="padding: 10px;">{{ $note }}</div>
                    </div>
                @endif
            @endforeach
        </div>
    ...
    <div class="box-title avoid-break">C. CATATAN NARASI PERKEMBANGAN (ASPEK)</div>
    @php
        $narrations = [
            [
        ...
        @if ($section['text'] || $section['photo'])
            <div class="avoid-break" style="margin-bottom: 10px; border: 1px solid #000; padding: 0;">
                ...
                <table width="100%" style="border: none; margin: 0;">
                    <tr>
                        <td class="text-justify pre-wrap" style="padding: 10px;">
    ...
    <div class="avoid-break">
        ...
        <div
            style="border: 1px solid #000; padding: 10px; min-height: 40px; margin-bottom: 10px; text-align: justify; font-style: italic; white-space: pre-line;">
        ...
        <div
            style="border: 1px solid #000; padding: 10px; min-height: 40px; text-align: justify; white-space: pre-line;">

...
<head>
    ...
    <style>
        ...
        @page {
            margin: 1cm;
            /* Margin kecil karena ada border */
        }
        ...
        body {
            ...
            color: #000;
            padding: 1.5cm 1cm;
            /* Padding konten di dalam border */
        }

        /** * BORDER HALAMAN (GAMBAR ATAU CSS)
         * Posisi fixed agar muncul di setiap halaman
         */
        .page-border {
            position: fixed;
            left: 0px;
            ...
            right: 0px;
            z-index: -1000;
            /* OPSI 1: JIKA PAKAI GAMBAR BORDER */
            /* background: url('{{ public_path('images/border.png') }}') no-repeat center center; */
            /* background-size: cover; */

            /* OPSI 2: JIKA PAKAI CSS (Default jika gambar tidak ada) */
...
<body>
    ...
    <div class="text-center bold" style="font-size: 16pt; margin-bottom: 30px; text-decoration: underline;">
        DATA DIRI ANAK
    </div>
    ...
    <table class="header-table">
        <tr>
            <td width="15%" align="center">
                <img src="{{ public_path('images/logo2.png') }}" style="height: 70px; width: auto;">
            </td>
            <td width="70%" align="center">
                ...
                <div class="school-address">
                    Jl. Giok No.17 Blok B.5 Perumahan Villa Pisma Asri, Desa Podo, Kec. Kedungwuni<br>
                    Kabupaten Pekalongan - Jawa Tengah 51173<br>
                    Email: ajpreschooldaycare@gmail.com
                </div>
            </td>
            <td width="15%" align="center">
    ...
    <div class="text-center bold" style="margin-bottom: 15px; font-size: 12pt; text-decoration: underline;">
    ...
    <table width="100%" style="margin-bottom: 20px; font-size: 10pt; border: 1px solid #ccc; padding: 5px;">
        ...
        <tr>
            ...
            <td>: {{ $report->student->group_name ?? 'KB/TK' }}</td>
            <td class="bold">Periode</td>
            <td>: {{ \Carbon\Carbon::parse($report->start_date)->format('d/m/y') }} -
    ...
    <div style="font-size: 8pt; margin-top: 5px; margin-bottom: 20px;">
        *Keterangan: <b>BB</b> (Belum Berkembang), <b>MB</b> (Mulai Berkembang), <b>BSH</b> (Berkembang Sesuai Harapan),
        <b>BSB</b> (Berkembang Sangat Baik)
    </div>

    <div class="box-title">B. CATATAN NARASI PERKEMBANGAN</div>
        ...
        @if ($section['text'] || $section['photo'])
            <div class="avoid-break" style="margin-bottom: 10px; border: 1px solid #000; padding: 0;">
                ...
                <table width="100%" style="border: none; margin: 0;">
                    <tr>
                        <td class="text-justify" style="padding: 10px;">
                            {{ $section['text'] ?? 'Belum ada narasi.' }}
                        </td>
    ...
    <div class="avoid-break">
        <div class="box-title">C. REFLEKSI & KESIMPULAN</div>
        ...
        <div
            ...
            {{ $report->parent_reflection_text ?? '(Mohon diisi oleh Orang Tua)' }}
        </div>
    ...
    <br>
    <div class="avoid-break">
        <div class="box-title">D. DATA KESEHATAN & PRESENSI</div>
        <table class="table-bordered" width="100%">
            <tr>

<x-app-layout>
    ...
    <div
        ...
        <form id="studentForm" method="POST" action="{{ route('siswa.update', $student->id) }}"
            ...
            <div id="step-1">
                        ...
                        <div
                            ...
                            <ol
                                ...
                                <li class="flex items-center gap-2 bg-white dark:bg-gray-900 p-2">
                                    <span
                                        class="size-6 rounded-full bg-blue-600 dark:bg-blue-800 text-white text-center text-[10px]/6 font-bold">
                                        1
                                    </span>

                                    <span class="hidden sm:block text-gray-800"> Daftar Siswa </span>
                                </li>
                                ...
                                <li class="flex items-center gap-2 bg-white dark:bg-gray-900 p-2">
                                    ...
                                    <span class="hidden sm:block"> Kondisi Siswa </span>
                                </li>
                                <li class="flex items-center gap-2 bg-white dark:bg-gray-900 p-2">
                                    <span
                                        class="size-6 rounded-full bg-gray-100 dark:bg-gray-500 text-center text-[10px]/6 font-bold text-white">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="national_id" class="block mt-1 w-full" type="text" name="national_id"
                        :value="$student->national_id" autocomplete="national_id" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="student_name" class="block mt-1 w-full" type="text" name="student_name"
                        :value="$student->student_name" required autofocus autocomplete="student_name" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="nickname" class="block mt-1 w-full" type="text" name="nickname"
                        :value="$student->nickname" required autocomplete="nickname" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="birth_place" class="block mt-1 w-full" type="text" name="birth_place"
                        :value="$student->birth_place" required autocomplete="birth_place" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="birth_date" class="block mt-1 w-full" type="date" name="birth_date"
                        :value="old('birth_date', optional($student->birth_date)->format('Y-m-d'))" required autocomplete="bday" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="father_name" class="block mt-1 w-full" type="text" name="father_name"
                        :value="$student->father_name" required autocomplete="father_name" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="mother_name" class="block mt-1 w-full" type="text" name="mother_name"
                        :value="$student->mother_name" required autocomplete="mother_name" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="street" class="block mt-1 w-full" type="text" name="street"
                        :value="$student->street" required autocomplete="street" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="village" class="block mt-1 w-full" type="text" name="village"
                        :value="$student->village" required autocomplete="village" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="subdistrict" class="block mt-1 w-full" type="text" name="subdistrict"
                        :value="$student->subdistrict" required autocomplete="subdistrict" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="district" class="block mt-1 w-full" type="text" name="district"
                        :value="$student->district" required autocomplete="district" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="phone_number" class="block mt-1 w-full" type="text" name="phone_number"
                        :value="$student->phone_number" required autocomplete="phone_number" />
                ...
                <!-- Foto -->
                <div class="mt-4">
                    <x-input-label for="user_photo" :value="__('Foto Siswa')" />
                    ...
                    <div class="mt-2">
                        <img id="user_photo_preview" src="{{ asset('storage/' . $student->user_photo) }}"
                ...
                <div class="flex justify-between mt-4">
                    ...
                    <x-primary-button id="next-btn-1" class="ml-auto">Next</x-primary-button>
                </div>
            </div>
            ...
            <div id="step-2" style="display:none;">
                    ...
                    <div
                        ...
                        <ol
                            ...
                            <li class="flex items-center gap-2 bg-white dark:bg-gray-900 p-2">
                                ...
                                <span class="hidden sm:block text-gray-800"> Kondisi Siswa </span>
                            </li>
                            <li class="flex items-center gap-2 bg-white dark:bg-gray-900 p-2">
                                <span
                                    class="size-6 rounded-full bg-gray-100 dark:bg-gray-500 text-center text-[10px]/6 font-bold text-white">
                ...
                <div class="mb-4">
                    <x-input-label for="student_is_normal" :value="__('Kondisi Siswa')" />
                    <select id="student_is_normal" name="student_is_normal"
                        ...
                        <option value="1"
                            {{ $student->activityTransaction->student_is_normal == 1 ? 'selected' : '' }}>Normal
                        </option>
                        <option value="0"
                            {{ $student->activityTransaction->student_is_normal == 0 ? 'selected' : '' }}>Abnormal
                        </option>
                    </select>
                    <x-input-error :messages="$errors->get('student_is_normal')" class="mt-2" />
                </div>

                {{-- Catatan --}}
                <div>
                    <label for="student_description"
                        class="block text-sm font-medium text-gray-700 dark:text-gray-300">Catatan
                        Kondisi:
                        <span class="text-xs content-center text-gray-500 mx-1">*opsional</span>
                    </label>
                    <textarea name="student_description" id="student_description" rows="4"
                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:text-white">{{ old('student_description', $student->student_description ?? '') }}</textarea>
                </div>

                <div class="flex justify-between mt-4">
                    <x-secondary-button id="back-btn-1">Back</x-secondary-button>
                    <x-primary-button id="next-btn-2" class="ml-auto">Next</x-primary-button>
                </div>
            </div>
            ...
            <div id="step-3" style="display:none;">
                    ...
                    <div
                        ...
                        <ol
                            ...
                            <li class="flex items-center gap-2 bg-white dark:bg-gray-900 p-2">
                                ...
                                <span class="hidden sm:block text-gray-800"> Program & Service </span>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <select id="program_id" name="program_id"
                        ...
                        @foreach ($programs as $program)
                            <option value="{{ $program->id }}"
                                {{ $program->id == $student->activityTransaction->program_id ? 'selected' : '' }}>
                    ...
                    <select id="service_id" name="service_id"
                        ...
                        @foreach ($services as $service)
                            <option value="{{ $service->id }}"
                                {{ $program->id == $student->activityTransaction->service_id ? 'selected' : '' }}>
                ...
                <div class="mt-4">
                    ...
                    <select id="student_status" name="student_status"
                        class="block mt-1 w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:focus:border-indigo-300 dark:focus:ring-indigo-300 rounded-md shadow-sm">
                        <option value="1"
                            {{ $student->activityTransaction->student_status == 1 ? 'selected' : '' }}>Siswa Active
                        </option>
                        <option value="0"
                            {{ $student->activityTransaction->student_status == 0 ? 'selected' : '' }}>Siswa Tidak
                            Active
                        </option>
                    </select>
                ...
                <div class="flex justify-between mt-4">
                    <x-secondary-button id="back-btn-2">Back</x-secondary-button>
    ...
    <script>
        ...
        document.getElementById('next-btn-1').addEventListener('click', function(event) {
        ...
        document.getElementById('next-btn-2').addEventListener('click', function(event) {
            event.preventDefault();
            document.getElementById('step-2').style.display = 'none';
        ...
        document.getElementById('submitFormButton').addEventListener('click', function(event) {
            ...
            Swal.fire({
                title: 'Konfirmasi',
                text: "Apakah data yakin untuk mengedit data?",
                icon: 'question',

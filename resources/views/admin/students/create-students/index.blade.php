            ...
            <div id="step-2" style="display:none;">
                ...
                <div class="mb-4">
                    ...
                    <select id="student_is_normal" name="student_is_normal"
                        ...
                        <option value="1" @selected(old('student_is_normal', $student->student_is_normal ?? '') == '1')>Normal</option>
                        <option value="0" @selected(old('student_is_normal', $student->student_is_normal ?? '') == '0')>Abnormal</option>
                    </select>

                    <x-input-error :messages="$errors->get('student_is_normal')" class="mt-2" />
                </div>

                {{-- Catatan Kodisi Siswa --}}
                <div>
                    ...
                    <x-input-error :messages="$errors->get('student_description')" class="mt-2" />
                </div>

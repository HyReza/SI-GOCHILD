<x-app-layout>
    <x-slot:title>Management Pengajar</x-slot:title>
    ...
    @endif
    <div x-data="{ open: false, showModal: false, teacher: {} }">
        <div x-data="{ open: false }">
            ...
            <div class="mb-6 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <button @click="open = true"
                    ...
                    <span class="text-sm">Tambah Pengajar</span>
                    <span
                ...
                <form method="GET" action="{{ route('pengajar.index') }}"
                    class="relative w-full md:w-96 flex items-center">
                    <span class="absolute left-3 text-gray-400 material-symbols-outlined text-[20px]">search</span>
                    <input type="text" name="search" placeholder="Cari nama pengajar..."
            ...
            <div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center px-4 py-6 sm:px-0">
                ...
                <div x-show="open" x-transition:enter="ease-out duration-300"
                    ...
                    <div
                        ...
                        <h2 class="text-lg font-bold text-gray-800 dark:text-white">Tambah Pengajar Baru</h2>
                    ...
                    {{-- Form Body --}}
                    <div class="p-6">
                        <form id="teacherForm" method="POST" action="{{ route('pengajar.store') }}"
                            ...
                            <div class="flex justify-end gap-3 pt-2">
                                ...
                                <button type="submit"
                                    class="px-4 py-2 text-sm font-medium text-white bg-green-500 rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                    Simpan Data
                                </button>
                            </div>
                        </form>
                ...
                <table class="min-w-full table-auto border-collapse mb-4">
                    <thead>
                        <tr
                            ...
                            <th class="py-3 px-6 text-left">Nama Pengajar</th>
                    ...
                    <tbody class="text-gray-600 dark:text-gray-300 text-sm font-light">
                        @forelse ($teachers as $teacher)
                            <tr
                                ...
                                <td class="py-3 px-6 text-left">{{ $teacher->user_name }}</td>
                                <td class="py-3 px-6 text-left">{{ $teacher->email }}</td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex gap-2 justify-center">
                                        <a href="#"
                                            @click="showModal = true; teacher = {{ $teacher->toJson() }}"
                                        ...
                                        <a href="{{ route('pengajar.edit', $teacher->id) }}" class="relative group">
                                            <span
                                        ...
                                        <form id="delete-form-{{ $teacher->id }}"
                                            action="{{ route('pengajar.destroy', $teacher) }}" method="POST"
        ...
        <div x-show="showModal" x-cloak
            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg max-w-md w-full relative">
                ...
                <h2 class="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Detail Pengajar</h2>
                <div class="mb-4 text-gray-800 dark:text-white">
                    <p><strong>Nama:</strong> <span x-text="teacher.user_name"></span></p>
                    <p><strong>Email:</strong> <span x-text="teacher.email"></span></p>
                    <p><strong>Nomor HP:</strong> <span x-text="teacher.phone_number"></span></p>
                    <p><strong>Role:</strong> Pengajar</p>
                </div>
    ...
    <script>
        function confirmAdd(event) {
            ...
            Swal.fire({
                ...
                text: "Apakah Anda yakin ingin menambah pengajar ini?",
                icon: 'question',

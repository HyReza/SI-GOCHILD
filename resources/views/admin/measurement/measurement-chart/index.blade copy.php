<x-app-layout>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const studentLineColor = isMale ? 'rgba(59, 130, 246, 1)' : 'rgba(236, 72, 153, 1)';
            ...
            // Fungsi untuk membuat garis terputus-putus
            ...
            function renderChart(config) {
                ...
                currentChart = new Chart(canvas, {
                    ...
                    data: {
                        datasets: [
                            // Urutan dataset penting untuk 'fill'. Dari atas ke bawah.
                            {
                                label: '+3 SD',

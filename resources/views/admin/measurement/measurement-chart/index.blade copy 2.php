        ...
        document.addEventListener('DOMContentLoaded', function() {
                ...
                currentChart = new Chart(canvas, {
                    ...
                    data: {
                        datasets: [
                            ...
                            // Titik Pengukuran Anak (digambar terakhir agar di atas)
                            {
            ...
            const chartConfigs = {
                'BB/U': {
                    ...
                    studentPoints: studentDataPoints.filter(p => p).map(p => ({
                        x: p.age,
                        y: p.weight
                    })),
                ...
                button.addEventListener('click', function() {
                    ...
                    renderChart({
                        ...
                        xAxisLabel: xAxisKey === 'age_months' ? 'Umur (bulan)' : (
                            ...
                            'Tinggi Badan (cm)'),
                        studentPoints: config.studentPoints,

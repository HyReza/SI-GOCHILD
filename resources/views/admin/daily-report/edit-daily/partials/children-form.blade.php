    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm text-left min-w-[800px]">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-900">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex gap-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="greeting_and_morning_prayer" value="mengikuti"
                                    @checked(old('greeting_and_morning_prayer', $detail->greeting_and_morning_prayer) == 'mengikuti') class="form-radio text-indigo-600">
                                <span class="ml-2 text-gray-700">Mengikuti</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="greeting_and_morning_prayer" value="tidak mengikuti"
                                    @checked(old('greeting_and_morning_prayer', $detail->greeting_and_morning_prayer) == 'tidak mengikuti') class="form-radio text-indigo-600">
                                <span class="ml-2 text-gray-700">Tidak Mengikuti</span>
                            </label>
                        </div>
                    </td>
                </tr>
                ...
                {{-- 07:30 - SESI 1 --}}
                <tr>
                    <td class="px-6 py-4 font-mono text-gray-500 dark:text-gray-400">07:30 - 09:00</td>
                    <td class="px-6 py-4 text-gray-700 dark:text-gray-300 font-medium">Bermain & Belajar <span
                            class="font-bold">Sesi 1</span></td>
                    <td class="px-6 py-4">
                        {{-- Dropdown Materi --}}
                        <select id="session1_material_id" name="session1_material_id"
                            ...
                            @if (isset($subthemes) && count($subthemes) > 0)
                                @foreach ($subthemes as $m)
                                    <option value="{{ $m['id'] }}" data-theme="{{ $m['theme_name'] }}"
                                        data-sub="{{ $m['sub_theme_name'] }}" @selected(old('session1_material_id', $detail->session1_material_id) == $m['id'])>
                                        {{ $m['material_name'] }}
                                    </option>
                                @endforeach
                            @else
                                <option value="" disabled>Tidak ada materi pada tanggal ini</option>
                            @endif
                        </select>
                        <div id="themeName1" class="mt-1 text-xs text-gray-500 dark:text-gray-400 italic">
                            {{-- Initial load text if needed can be handled via JS on page load --}}
                        </div>
                            ...
                            @foreach (['BB', 'MB', 'BSH', 'BSB'] as $s)
                                <label class="inline-flex items-center cursor-pointer group">
                                    <input type="radio" name="session1_activity" value="{{ $s }}"
                                        @checked(old('session1_activity', $detail->session1_activity) == $s)
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex gap-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="toilet_training_and_duha_prayer" value="mengikuti"
                                    @checked(old('toilet_training_and_duha_prayer', $detail->toilet_training_and_duha_prayer) == 'mengikuti') class="form-radio text-indigo-600">
                                <span class="ml-2 text-gray-700">Mengikuti</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="toilet_training_and_duha_prayer" value="tidak mengikuti"
                                    @checked(old('toilet_training_and_duha_prayer', $detail->toilet_training_and_duha_prayer) == 'tidak mengikuti') class="form-radio text-indigo-600">
                                <span class="ml-2 text-gray-700">Tidak Mengikuti</span>
                            </label>
                        </div>
                    </td>
                ...
                {{-- 09:30 - SESI 2 --}}
                <tr>
                    <td class="px-6 py-4 font-mono text-gray-500 dark:text-gray-400">09:30 - 10:00</td>
                    <td class="px-6 py-4 text-gray-700 dark:text-gray-300 font-medium">Bermain & Belajar <span
                            class="font-bold">Sesi 2</span></td>
                    <td class="px-6 py-4">
                        {{-- Dropdown Materi --}}
                        <select id="session2_material_id" name="session2_material_id"
                            ...
                            @if (isset($subthemes) && count($subthemes) > 0)
                                @foreach ($subthemes as $m)
                                    <option value="{{ $m['id'] }}" data-theme="{{ $m['theme_name'] }}"
                                        data-sub="{{ $m['sub_theme_name'] }}" @selected(old('session2_material_id', $detail->session2_material_id) == $m['id'])>
                                        {{ $m['material_name'] }}
                                    </option>
                                @endforeach
                            @else
                            ...
                            @foreach (['BB', 'MB', 'BSH', 'BSB'] as $s)
                                <label class="inline-flex items-center cursor-pointer group">
                                    <input type="radio" name="session2_activity" value="{{ $s }}"
                                        @checked(old('session2_activity', $detail->session2_activity) == $s)
                                        class="text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-gray-600 dark:bg-gray-700">
                                    <span
                                        class="ml-1.5 text-gray-600 dark:text-gray-300 text-xs font-bold group-hover:text-indigo-600 transition-colors">{{ $s }}</span>
                                </label>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex gap-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="morning_snack" value="habis" @checked(old('morning_snack', $detail->morning_snack) == 'habis')
                                    class="form-radio text-indigo-600">
                                <span class="ml-2 text-gray-700">Habis</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="morning_snack" value="tidak habis"
                                    @checked(old('morning_snack', $detail->morning_snack) == 'tidak habis') class="form-radio text-indigo-600">
                                <span class="ml-2 text-gray-700">Tidak Habis</span>
                            </label>
                        </div>
                    </td>
                </tr>
                            ...
                            @foreach (['mandiri' => 'Mandiri', 'kurang mandiri' => 'Kurang', 'tidak mandiri' => 'Tidak'] as $val => $label)
                                <label class="inline-flex items-center">
                                    <input type="radio" name="neatness_and_independence"
                                        value="{{ $val }}" @checked(old('neatness_and_independence', $detail->neatness_and_independence) == $val)
                                        class="form-radio text-indigo-600">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex flex-wrap gap-4">
                            @foreach (['habis', 'sisa sedikit', 'sisa banyak'] as $val)
                                <label class="inline-flex items-center">
                                    <input type="radio" name="cheerful_lunch" value="{{ $val }}"
                                        @checked(old('cheerful_lunch', $detail->cheerful_lunch) == $val) class="form-radio text-indigo-600">
                                    <span class="ml-2 text-gray-700 capitalize">{{ $val }}</span>
                                </label>
                            @endforeach
                        </div>
                    </td>
                            ...
                            @foreach (['baik', 'cukup', 'kurang'] as $val)
                                <label class="inline-flex items-center">
                                    <input type="radio" name="cleanliness_and_brushing_training"
                                        value="{{ $val }}" @checked(old('cleanliness_and_brushing_training', $detail->cleanliness_and_brushing_training) === $val)
                                        class="form-radio text-indigo-600">
                                    <span class="ml-2 text-gray-700 capitalize">{{ $val }}</span>
                                </label>
                            @endforeach
                        ...
                        <div class="flex gap-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="dhuhr_prayer" value="mengikuti"
                                    @checked(old('dhuhr_prayer', $detail->dhuhr_prayer) == 'mengikuti') class="form-radio text-indigo-600">
                                <span class="ml-2 text-gray-700">Mengikuti</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="dhuhr_prayer" value="tidak mengikuti"
                                    @checked(old('dhuhr_prayer', $detail->dhuhr_prayer) == 'tidak mengikuti') class="form-radio text-indigo-600">
                                <span class="ml-2 text-gray-700">Tidak Mengikuti</span>
                            </label>
                        </div>
                    </td>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex flex-wrap gap-4">
                            @foreach (['tidur' => 'Tidur', 'tidur sebentar' => 'Sebentar', 'tidak tidur' => 'Tidak'] as $val => $label)
                                <label class="inline-flex items-center">
                                    <input type="radio" name="healthy_sleep" value="{{ $val }}"
                                        @checked(old('healthy_sleep', $detail->healthy_sleep) == $val) class="form-radio text-indigo-600">
                                    <span class="ml-2 text-gray-700">{{ $label }}</span>
                                </label>
                            @endforeach
                        </div>
                        ...
                        <div class="flex gap-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="afternoon_bath" value="mengikuti"
                                    @checked(old('afternoon_bath', $detail->afternoon_bath) == 'mengikuti') class="form-radio text-indigo-600">
                                <span class="ml-2 text-gray-700">Mengikuti</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="afternoon_bath" value="tidak mengikuti"
                                    @checked(old('afternoon_bath', $detail->afternoon_bath) == 'tidak mengikuti') class="form-radio text-indigo-600">
                                <span class="ml-2 text-gray-700">Tidak Mengikuti</span>
                            </label>
                        </div>
                    </td>
                        ...
                        <div class="flex gap-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="afternoon_snack" value="habis"
                                    @checked(old('afternoon_snack', $detail->afternoon_snack) == 'habis') class="form-radio text-indigo-600">
                                <span class="ml-2 text-gray-700">Habis</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="afternoon_snack" value="tidak habis"
                                    @checked(old('afternoon_snack', $detail->afternoon_snack) == 'tidak habis') class="form-radio text-indigo-600">
                                <span class="ml-2 text-gray-700">Tidak Habis</span>
                            </label>
                        </div>
                    </td>
                        ...
                        <div class="flex gap-4">
                            <label class="inline-flex items-center">
                                <input type="radio" name="asr_prayer" value="mengikuti"
                                    @checked(old('asr_prayer', $detail->asr_prayer) == 'mengikuti') class="form-radio text-indigo-600">
                                <span class="ml-2 text-gray-700">Mengikuti</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="asr_prayer" value="tidak mengikuti"
                                    @checked(old('asr_prayer', $detail->asr_prayer) == 'tidak mengikuti') class="form-radio text-indigo-600">
                                <span class="ml-2 text-gray-700">Tidak Mengikuti</span>
                            </label>
                        </div>
                    </td>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                    ...
                    <td class="px-6 py-4 space-y-2">
                        <textarea name="extra_stimulation_description" rows="1"
                            ...
                            placeholder="Deskripsi (opsional)">{{ old('extra_stimulation_description', $detail->extra_stimulation_description) }}</textarea>
                        <div class="flex gap-3">
                            @foreach (['BB', 'MB', 'BSH', 'BSB'] as $opt)
                                <label class="inline-flex items-center">
                                    <input type="radio" name="extra_stimulation" value="{{ $opt }}"
                                        @checked(old('extra_stimulation', $detail->extra_stimulation) === $opt) class="form-radio text-indigo-600">
                                    <span class="ml-1 text-xs font-bold text-gray-600">{{ $opt }}</span>
                                </label>
                            @endforeach
                        </div>
                    </td>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                    ...
                    <td class="px-6 py-4 space-y-2">
                        <textarea name="cheerful_play_description" rows="1"
                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                            placeholder="Deskripsi (opsional)">{{ old('cheerful_play_description', $detail->cheerful_play_description) }}</textarea>
                        <div class="flex gap-3">
                            @foreach (['BB', 'MB', 'BSH', 'BSB'] as $opt)
                                <label class="inline-flex items-center">
                                    <input type="radio" name="cheerful_play" value="{{ $opt }}"
                                        @checked(old('cheerful_play', $detail->cheerful_play) === $opt) class="form-radio text-indigo-600">
                                    <span class="ml-1 text-xs font-bold text-gray-600">{{ $opt }}</span>
                                </label>
                            @endforeach
                        </div>

<x-app-layout>
    <x-slot:title>Pengaturan Admin</x-slot:title>
        ...
        <ol
            ...
            <li class="flex items-center">
                <a href="{{ route('admin.index') }}"
                    ...
                    <span class="ms-1.5 text-xs font-medium dark:text-gray-300"> Daftar Admin </span>
                </a>
            </li>
    ...
    <div
        ...
        <h2 class="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Edit Admin</h2>
        ...
        <form action="{{ route('admin.update', $admin->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <!-- Name -->
            <div class="mb-4">
                <x-input-label for="user_name" :value="__('Nama Admin')" />
                <x-text-input id="user_name" class="block mt-1 w-full" type="text" name="user_name" :value="old('user_name', $admin->user_name)"
                    required />
            ...
            <div class="mb-4">
                ...
                <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $admin->email)"
                    required />
            ...
            <div class="mb-4">
                ...
                <select id="role_id" name="role_id"
                    ...
                    <option value="2" {{ old('role_id', $admin->role_id) == 2 ? 'selected' : '' }}>Pengajar
                    </option>
        ...
        function confirmAdd(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    setTimeout(() => {
                        document.getElementById('adminForm').submit(); // Submit form

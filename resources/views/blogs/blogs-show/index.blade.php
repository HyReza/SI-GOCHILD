<x-guest-layout>
    ...
    <div class="max-w-7xl mt-24 mx-auto px-4 md:px-8 py-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg mb-12">
        ...
        <div class="flex flex-col items-center mb-8">
            ...
            <!-- Judul Artikel -->
            <h1 class="text-4xl font-extrabold text-gray-900 dark:text-gray-200 mb-4">{{ $article->title }}</h1>

            <!-- Informasi Artikel: Penulis, Tanggal, Kategori -->
        ...
        <!-- Content and Description Card: Konten Artikel -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Deskripsi Artikel -->
            <div class="md:col-span-3 bg-gray-50 dark:bg-gray-700 rounded-lg shadow-md p-8">
                <div class="ql-container ql-snow prose lg:prose-xl max-w-none">
                    <!-- Menampilkan konten dengan gaya Quill -->
                    {!! $article->content !!}
                </div>
            </div>
        </div>

        <!-- Related Articles Section: Berita Terkait -->
        <div class="mt-12">
            <h2 class="text-3xl font-semibold text-gray-900 dark:text-gray-200 mb-6">Berita Terkait</h2>
            ...
            @else
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach ($relatedArticles as $related)
                        <div
                            class="bg-gray-50 dark:bg-gray-700 rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-gray-500 text-sm mt-2 dark:text-gray-400">Dipublikasikan pada:

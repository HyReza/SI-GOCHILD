        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 lg:col-span-2">
                    ...
                    {{-- UPDATED: Grid Layout menjadi 4 kolom untuk memuat Lingkar Kepala --}}
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        ...
                        {{-- 3. Lingkar Kepala (BARU DITAMBAHKAN) --}}
                        <div
                            class="p-4 bg-gradient-to-br from-purple-50 to-white rounded-xl border border-purple-100 text-center shadow-sm">
                            <p class="text-xs text-purple-500 uppercase font-bold mb-1">Lingkar Kepala</p>
                            <p class="text-2xl font-black text-purple-700">
                                {{ ($report->head_circumference ?? 0) + 0 }}
                                <span class="text-sm font-medium text-gray-500">cm</span>
                            </p>
                        </div>
